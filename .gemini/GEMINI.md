...
> 📌 **目的**: 本文档旨在建立稳定、可持续演进的人机协作规范体系，确保知识完整沉淀为文档而非仅存在于代码或对话中。作为 Gemini (Antigravity) Agent，我将严格遵循此指南。
...
> 💡 **新 Gemini 会话启动指南**: 如果你是新开的会话，请查看 [🚀 新 Gemini 会话快速启动指南](#-新-gemini-会话快速启动指南) 章节。
...
- Update Gemini.md with encryption workflow
...
> ⚠️ **重要**: 当你开启新的 Gemini 会话时，请遵循此指南确保无缝衔接！

### 🎯 启动新会话的标准流程

**你只需复制粘贴以下消息给新 Gemini 会话**：
...
- [ ] `Gemini.md` - 是否需要更新架构图或核心流程

#### 2. 修改核心逻辑时
- [ ] `docs/architecture/*.md` - 是否需要更新架构设计文档
- [ ] `Gemini.md` - 是否需要更新"核心设计原理"章节
